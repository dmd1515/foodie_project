...
def generatePrompt(ingredients, mealTime, mealType, mealDiff, cookTime, useExtraIngredients):
    ...
    templatePrompt4 = ". Your recipes must include the name of the dish, cooking time, ingredients and instructions. Your reply text should only consist of the recipes and nothing more."
...
def sendPrompt(data):
    ...
    #)
    prompt = {"response": "This is a mock response for the prompt: " + prompt}
    return prompt
